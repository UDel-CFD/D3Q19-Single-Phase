...
!        if (myid.eq.0)write(*,*)'Entered main loop'
        ...
        !@file collision.f90
!        if (myid.eq.0)write(*,*)'Died before collision'
        bnchstart = MPI_WTIME()
        call collision_MRT
...
!          if(myid.eq.0)write(*,*)'Passed beads_redistribute'
...
!          if(myid.eq.0)write(*,*)'Passed beads_links'
...
!        if(myid.eq.0)write(*,*)'Passed macrovar'
